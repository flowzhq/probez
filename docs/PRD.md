...
`rounds` filters on both. It needed no additional collection, which is the claim below being
demonstrated rather than asserted. v0.2 still owes the path half, and the round-level categories
themselves.
